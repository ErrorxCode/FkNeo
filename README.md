...
<p align="center">F**K Neo gives you <strong>freedom</strong> which you do not get normally because of <strong>NeoExamShield/Neo browser</strong></p>
<br/>
...
<br/>
<p align="center"><strong>Helps you</strong> write code & <strong>solve problems</strong> efficiently on any imneo/examly based platform</p>
<br/>    
...
- **No NeoExamShield** - No need to install any kind of extension
- **No entire screen recording** - You can choose any particular tab/window to record because privacy is your right
- **Screen recording bypassed**ᴺᵉʷ⭐ - You can stop the screen sharing anytime
- **Allow tab/window** - Change/Switch between tabs easily
- **Allow copy/paste** - Copy paste code easily
- **No need Neo-Browser** - No Need to install any virus on your device
...
Once the bypass is disabled, you will start getting warnings for switching tabs/windows and all other activities that are not allowed


> [!IMPORTANT]
> For license activation, contact @x03rror on [Telegram](https://t.me/x03rror?text=Hey,%20I%20want%20to%20purchase%20license%20key) or @fkneo.x on [Instagram](https://instagram.com/fkneo.x). It may take up to 2 business days.

## 🎹 Keyboard shotcuts
| Shortcut       	| Function                                   	| Used when                       	|
|----------------	|--------------------------------------------	|---------------------------------	|
| Alt + Ctrl + B 	| Resolve all the test cases and proceed     	| Coding                          	|
| Alt + T        	| Auto-type code                             	| Coding                          	|
| Alt + M        	| Choose the correct option                  	| MCQ (Single choice only)        	|
| Alt + D        	| Disable cheating functionality             	| Anywhere  (May freeze the test) 	|
| Alt + R        	| Re-enable cheating and re-load test window 	| Anywhere (Reload window)        	|
| Shift + P      	| Set custom IP                              	| Before starting test            	|
| Shift + O      	| Spoofs OS to linux                         	| Before starting test            	|
...
**Ans.** No, not at least remotely

**Q.** Can I use this extension on MAC/Linux

**Ans.** Yes! It's just a browser extension which you can install anywhere
...
**Ans.** FkNeo relies on the test backend. If the teacher has not uploaded the solution there, then it won't work

**Q.** Can extension be deactivated from the menu?

**Ans.** NO! You can't turn off the extension for a particular site using the popup menu.
...
## Support
This project comprises of lot's of energy, brainstorming, coding, testing and time. If this project has helped you in any way, please consider giving it a ⭐ to show your support and help it grow! Also, *watch* the repo to be notified about updates.
